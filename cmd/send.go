...
msg (message) & con-id (id of the connection) flags are required flags on the command.
from (name of the sender) flag is optional. con-id is uuid that is created during agent connection.
