...
require (
	github.com/findy-network/findy-agent v0.0.0-20201110172509-f2477cd2de81
	github.com/findy-network/findy-agent-api v0.0.0-20201109160522-df5a4d4cb181
	github.com/findy-network/findy-grpc v0.0.0-20201110170607-a07615c4d51d // indirect
